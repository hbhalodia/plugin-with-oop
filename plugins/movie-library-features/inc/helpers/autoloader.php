 ...
 *
 * @package movie-library-featuers
 */

namespace Movie_Library\Features\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	$resource_path  = false;
	$namespace_root = 'Movie_Library\Features\\';
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( MOVIE_LIBRARY_FEATURES_PATH ), $directory, $file_name );
...
spl_autoload_register( '\Movie_Library\Features\Inc\Helpers\autoloader' );
